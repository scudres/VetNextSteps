...
const trainingItems = [
  { title: "CVS Veterinary Group Graduate Programme", subtitle: "CVS Group", description: "Graduate development programme with mentorship and structured learning across CVS's nationwide network of practices.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["CVS", "graduate", "UK", "mentorship", "primary care"] },
  { title: "IVC Evidensia Graduate Academy", subtitle: "IVC Evidensia", description: "Graduate academy offering structured learning, mentoring, and career development opportunities across IVC Evidensia's European and UK practices.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["IVC", "IVC Evidensia", "Evidensia", "graduate", "UK", "Europe", "academy", "mentoring"] },
  { title: "Linnaeus Veterinary Graduate Development Programme", subtitle: "Linnaeus Group", description: "18-month structured programme with clinical rotations, mentoring, and professional development across Linnaeus's specialist and primary care hospitals.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["Linnaeus", "graduate", "UK", "rotations", "mentoring", "18 month"] },
  { title: "Medivet Early Careers Programme", subtitle: "Medivet", description: "Early career development with mentoring and structured learning pathways, supporting new graduates through their first years in practice.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["Medivet", "graduate", "UK", "early career", "mentoring"] },
  { title: "Vets4Pets Graduate Programme", subtitle: "Vets4Pets", description: "Graduate programme focusing on primary care development with ongoing clinical support, mentoring, and structured learning opportunities.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["Vets4Pets", "graduate", "UK", "primary care", "Companion Care"] },
  { title: "VetPartners Graduate Programme", subtitle: "VetPartners", description: "Structured graduate programme with dedicated clinical mentoring and professional development opportunities across VetPartners's diverse practice network.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["VetPartners", "graduate", "UK", "mentoring"] },
  // USA
  { title: "VCA Academy Mentorship Program", subtitle: "VCA Animal Hospitals (Mars Veterinary Health)", description: "6-month structured GP mentorship with tailored tracks for surgery, dentistry, and medical appointments. CE stipend and no negative accrual ProSal. Available USA & Canada.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["VCA", "Mars", "graduate", "USA", "Canada", "mentorship", "GP", "surgery", "dentistry", "ECC"] },
  { title: "Banfield Veterinary Emerging Leader Program", subtitle: "Banfield Pet Hospital (Mars Veterinary Health)", description: "12-month GP programme with a dedicated in-hospital coach, multi-phase onboarding, no-negative-accrual ProSal, and leadership development pathways.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["Banfield", "Mars", "graduate", "USA", "mentorship", "GP", "leadership", "ProSal"] },
  { title: "BluePearl EmERge Training Program", subtitle: "BluePearl Specialty + Emergency (Mars Veterinary Health)", description: "One-year ECC training programme comprising bootcamp, mentored immersion, and experiential phases. Followed by a two-year work commitment.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["BluePearl", "Mars", "ECC", "emergency", "USA", "graduate", "bootcamp", "critical care"] },
  { title: "VEG NERD Program (New ER Doctor)", subtitle: "Veterinary Emergency Group (VEG)", description: "Immersive 6-month ECC programme with travel-based surgical wet labs, full-time shifts with senior mentors, and approximately 160 RACE CE hours.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["VEG", "NERD", "emergency", "ECC", "USA", "graduate", "wet lab", "critical care"] },
  { title: "ER Immerse Program", subtitle: "Ethos Veterinary Health", description: "6-month ECC mentorship programme with in-hospital support from ER clinicians and ECC specialists and competency-based curriculum via VetBloom.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["Ethos", "emergency", "ECC", "USA", "graduate", "VetBloom", "critical care"] },
  { title: "NVA General Practice Mentorship Program", subtitle: "National Veterinary Associates (NVA)", description: "Up to 12-month GP programme with a designated in-clinic mentor, quarterly check-ins, peer case reviews, and $5,000 CE budget. Available USA & Canada.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["NVA", "National Veterinary Associates", "graduate", "USA", "Canada", "GP", "mentorship"] },
  { title: "Vetcor New Graduate Support Program", subtitle: "Vetcor", description: "12-month GP and mixed programme with one-on-one in-hospital mentorship, virtual roundtables, and skill-building days. Available USA & Canada.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["Vetcor", "graduate", "USA", "Canada", "mentorship", "GP", "mixed practice"] },
  { title: "Harbor GO Career Journey", subtitle: "Suveto / Harbor.vet Network", description: "Self-guided 12–24 month non-contract framework covering clinical excellence, business fluency, financial literacy, and co-ownership pathways.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["Suveto", "Harbor", "graduate", "USA", "mentorship", "dentistry", "surgery"] },
  { title: "MVP MBark Graduate Mentorship Program", subtitle: "Mission Pet Health (formerly Mission Veterinary Partners)", description: "12-month GP programme where mentors complete MBark Clinical Mentor Certification. Includes structured progression phases and custom dentistry labs.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["MVP", "Mission", "MBark", "graduate", "USA", "mentorship", "GP", "dentistry"] },
  { title: "SVP Doctor Mentorship Program", subtitle: "Mission Pet Health (formerly Southern Veterinary Partners)", description: "12-month GP programme with a paired on-site coach, Lead DVM Foundations training, and 50+ hours of RACE-approved CE across 850+ hospitals.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["SVP", "Southern Veterinary Partners", "Mission", "graduate", "USA", "mentorship", "GP", "dentistry"] },
  { title: "RISE DVM / VMD Mentorship Program", subtitle: "PetVet Care Centers", description: "12-month immersive programme with dual mentorship, tailored caseload ramp-up, national peer cohort, and up to $50,000 in new-grad incentives.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["PetVet", "RISE", "graduate", "USA", "mentorship", "ECC", "mixed animal"] },
  { title: "Thrive Doctor Mentorship Program", subtitle: "Thrive Pet Healthcare", description: "12-month GP, urgent care, and specialty programme with structured milestone curriculum, wellbeing support, and both Regional and on-site mentors.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["Thrive", "graduate", "USA", "mentorship", "GP", "urgent care", "specialty"] },
  { title: "Emergency Clinician Mentorship Program (ECMP)", subtitle: "MedVet", description: "6–12 month immersive ECC programme with 1:1 mentorship in a high-volume ER, designed to transition new graduates to standalone emergency clinicians.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["MedVet", "ECMP", "emergency", "ECC", "USA", "graduate", "critical care"] },
  { title: "ACCESS Accelerated Training (AAT)", subtitle: "ACCESS Specialty Animal Hospitals (Thrive Network)", description: "One-year ECC training programme with a two-year work commitment, progressing through foundation and specialist didactics and mentored hands-on work.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["ACCESS", "AAT", "emergency", "ECC", "USA", "graduate", "Thrive", "Florida", "critical care"] },
  { title: "AmeriVet Doctor Mentorship Program", subtitle: "AmeriVet Veterinary Partners", description: "12-month GP and urgent care programme with 1:1 on-site mentor, monthly virtual cohort conversations, and a clinical Hot Topics series.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["AmeriVet", "graduate", "USA", "mentorship", "GP", "urgent care"] },
  { title: "Heartland New Graduate Onboarding & Mentorship", subtitle: "Heartland Veterinary Partners", description: "12-month GP programme with a tailored caseload ramp-up schedule, structured procedural checklists, and a designated in-hospital DVM mentor.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["Heartland", "graduate", "USA", "mentorship", "GP", "spay", "neuter", "dentistry"] },
  { title: "Rarebreed Early Career Mentorship", subtitle: "Rarebreed Veterinary Partners", description: "12-month GP and urgent care programme with clinical autonomy, mentor support, the Rarebreed Learning Lab platform, and mental-health resources.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["Rarebreed", "graduate", "USA", "mentorship", "GP", "urgent care", "wellbeing"] },
  { title: "Alliance Academy Mentors Program", subtitle: "Alliance Animal Health", description: "12-month GP and urgent care programme with dual-tier mentoring, board-certified dentistry and surgery wet labs, and monthly compassion-fatigue sessions.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["Alliance", "graduate", "USA", "mentorship", "GP", "dentistry", "surgery", "urgent care"] },
  { title: "Affinity Veterinary Academy Graduate Transition Program", subtitle: "CityVet", description: "12-month GP and urgent care programme via the Affinity Veterinary Academy with abdominal ultrasound training and zero negative-accrual ProSal.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["Affinity", "CityVet", "graduate", "USA", "mentorship", "GP", "ultrasound", "ProSal"] },
  { title: "CVP Doctor Mentorship Framework", subtitle: "Community Veterinary Partners (CVP)", description: "12-month programme across GP, exotics, and equine practices with custom medical-autonomy mentorship and structured ProSal.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["CVP", "Community Veterinary Partners", "graduate", "USA", "mentorship", "GP", "exotics", "equine"] },
  { title: "Innovetive University One-Year Mentor Program", subtitle: "Innovetive Petcare", description: "12-month programme combining in-clinic modules with third-party clinical training, Global FAST ultrasound certification, and dentistry tracks.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["Innovetive", "graduate", "USA", "mentorship", "ultrasound", "FAST", "dentistry", "exotics"] },
  { title: "Destination Pet New Graduate Mentorship Framework", subtitle: "Destination Pet", description: "12-month GP and urgent care programme with a whole-health multi-site framework, $3,000–$5,000 CE allowance, and technical skill check-offs.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["Destination Pet", "graduate", "USA", "mentorship", "GP", "urgent care"] },
  { title: "VPP New Graduate Mentorship Framework", subtitle: "Veterinary Practice Partners (VPP)", description: "12-month GP programme maintaining local practice identity while providing network CE access, personal mentorship blueprints, and soft-skills development.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["VPP", "Veterinary Practice Partners", "graduate", "USA", "mentorship", "GP"] },
  { title: "Ready, Vet, Go Mentorship Integration Program", subtitle: "Ready, Vet, Go", description: "6-month structured curriculum with a one-year community membership, embedding graduate training into independent and private practices. Available USA & Canada.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["Ready Vet Go", "graduate", "USA", "Canada", "mentorship", "independent practice"] },
  { title: "United Veterinary Care New Graduate Mentorship", subtitle: "United Veterinary Care (UVC)", description: "Dedicated GP mentorship programme for new graduates entering clinical practice at United Veterinary Care locations.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["UVC", "United Veterinary Care", "graduate", "USA", "mentorship", "GP"] },
  { title: "Vetco Total Care PACKS Early Career Mentorship", subtitle: "Petco / Vetco Total Care", description: "Personalised GP mentor-doctor pairing with a co-created development plan and Merck-sponsored MentorVet Lift membership.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["Vetco", "Petco", "PACKS", "graduate", "USA", "mentorship", "GP", "MentorVet"] },
  { title: "Mentoring@AVMA", subtitle: "American Veterinary Medical Association", description: "6-month structured virtual mentoring programme pairing early-career vets with trained mentors. Not employer-hosted — open to any US graduate.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["AVMA", "mentoring", "USA", "graduate", "virtual", "independent"] },
  { title: "MentorVet Leap", subtitle: "MentorVet", description: "Evidence-based approximately 6-month transition-to-practice programme with cohort learning, 1:1 coaching, and a wellbeing curriculum.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["MentorVet", "Leap", "graduate", "USA", "mentorship", "wellbeing", "burnout"] },
  // Canada
  { title: "VetStrategy New Grad Mentorship Program", subtitle: "VetStrategy (IVC Evidensia family)", description: "12-month framework adapted from IVC Evidensia's European Graduate Academy, with regional mentor pairings, procedural logs, CE camps, and optional teaching-hospital placement.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["VetStrategy", "IVC", "graduate", "Canada", "mentorship", "GP"] },
  { title: "P3 Veterinary Partners Mentorship Program", subtitle: "P3 Veterinary Partners", description: "Goals-based GP mentorship with targeted individual and group CE including virtual learning, 1:1 sessions, wet labs, and courses.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["P3", "graduate", "Canada", "mentorship", "GP"] },
  { title: "VIRMP Rotating Internship (Canada)", subtitle: "Veterinary Internship & Residency Matching Program", description: "One-year rotating internships at Canadian veterinary teaching hospitals including Ontario Veterinary College (OVC) and Western College of Veterinary Medicine (WCVM).", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["VIRMP", "internship", "Canada", "OVC", "WCVM", "rotating"] },
  { title: "Greencross Vets Graduate Vet Program", subtitle: "Greencross Vets", description: "Structured graduate programme with dedicated mentorship, ongoing clinical education, and professional development across Australia.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["Greencross", "graduate", "Australia", "mentor"] },
  { title: "Apiam Animal Health Graduate Program", subtitle: "Apiam Animal Health", description: "Graduate development programme focused on rural, regional, and production animal practice across regional Australia.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["Apiam", "graduate", "Australia", "rural", "farm animal", "production"] },
  { title: "AVA Mentoring Program", subtitle: "Australian Veterinary Association", description: "The AVA connects new graduate veterinarians with experienced mentors for professional guidance and career development.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["AVA", "mentoring", "Australia", "graduate"] },
