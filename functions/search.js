...
const trainingItems = [
  ...
  { title: "VIRMP Rotating Internship", subtitle: "Veterinary Internship & Residency Matching Program", description: "One-year rotating internships at AVMA-accredited teaching hospitals and private practices across the USA.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["VIRMP", "internship", "USA", "AVMA", "matching", "rotating"] },
  { title: "Banfield New Graduate Program", subtitle: "Banfield Pet Hospital", description: "Structured onboarding and mentorship programme for new veterinary graduates with dedicated mentor support and continuing education credits.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["Banfield", "graduate", "USA", "mentor", "CE"] },
  { title: "VCA New Graduate Support", subtitle: "VCA Animal Hospitals", description: "New graduate support programme with mentorship, structured CE resources, and clinical development pathways.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["VCA", "graduate", "USA", "mentorship"] },
  { title: "National Veterinary Associates New Graduate Programme", subtitle: "National Veterinary Associates (NVA)", description: "Mentored onboarding and ongoing clinical support for new graduates entering NVA practices.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["NVA", "National Veterinary Associates", "graduate", "USA", "mentoring"] },
  ...
  { title: "Banfield Canada New Graduate Program", subtitle: "Banfield Pet Hospital Canada", description: "Mentored new graduate programme with structured learning pathways and continuing education resources across Banfield's Canadian locations.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["Banfield", "graduate", "Canada", "mentor"] },
  { title: "VCA Canada New Graduate Support", subtitle: "VCA Canada Animal Hospitals", description: "New graduate mentorship and structured professional development for veterinarians joining VCA Canada.", section: "Graduate Development Programmes", navPath: "/training-programs", tags: ["VCA", "VCA Canada", "graduate", "Canada", "mentorship"] },
