...
exports.handler = async (event) => {
  ...
  try {
    return {
      ...
      body: JSON.stringify({ uk: ukPrograms, usa: usaCertCategories, australia: australiaPrograms, newZealand: newZealandPrograms }),
    };
  } catch (err) {
    console.error("certificates handler error:", err.message);
