...
// Canonical postgraduate certificate data.
// Mirrors the shape exported from frontend/src/data/certificatesData.js
// so the API response can be used directly by the frontend components.
...
module.exports = { ukPrograms, usaCertCategories, australiaPrograms, newZealandPrograms };
